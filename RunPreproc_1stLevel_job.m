...
subjects = [30 39 72 73]; % Replace with a list of all of the subjects you wish to analyze
...
if exist(['/data/dpt_fmri-comparative-2022_timeout20221231/ds000158/sub-' subject '/func/sub-' subject '_task-passivelistening_bold.nii']) == 0
    display('Run 1 has not been unzipped; unzipping now')
    gunzip(['/data/dpt_fmri-comparative-2022_timeout20221231/ds000158/sub-' subject '/func/sub-' subject '_task-passivelistening_bold.nii.gz'])
else
    display('Run 1 is already unzipped; doing nothing')
end

if exist(['/data/dpt_fmri-comparative-2022_timeout20221231/ds000158/sub-' subject '/anat/sub-' subject '_T1w.nii']) == 0
    display('Anatomical image has not been unzipped; unzipping now')
    gunzip(['/data/dpt_fmri-comparative-2022_timeout20221231/ds000158/sub-' subject '_T1w.nii.gz'])
else
...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {{['/data/dpt_fmri-comparative-2022_timeout20221231/ds000158/sub-' subject '/func/sub-' subject '_task-passivelistening_bold.nii']}};
...
matlabbatch{4}.spm.spatial.coreg.estwrite.source = {['/data/dpt_fmri-comparative-2022_timeout20221231/ds000158/sub-' subject '/anat/sub-' subject '_T1w.nii,1']};
...
matlabbatch{5}.spm.spatial.coreg.estwrite.ref = {'/data/dpt_fmri-comparative-2022_timeout20221231/spm12/avg152T1.nii,1'};
...
matlabbatch{10}.spm.stats.fmri_spec.dir = {['/data/dpt_fmri-comparative-2022_timeout20221231/ds000158/sub-' subject '/1stLevel']};
